...
*** Use (neo)vi(m) keybindings (aka Evil keybindings)?
...
*** Temporaraly highlight some word?
...
*** Know what is changed when closing Emacs or several files?
